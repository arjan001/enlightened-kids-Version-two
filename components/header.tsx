      ...
      <header className="border-b bg-white fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8">
            <Link href="/books" className="text-gray-700 hover:text-orange-500 font-bold transition-colors">
              Books
            </Link>
            <Link href="/about" className="text-gray-700 hover:text-orange-500 font-bold transition-colors">
              About
            </Link>
            <Link href="/blog" className="text-gray-700 hover:text-orange-500 font-bold transition-colors">
              Blog
            </Link>
            <Link href="/contact" className="text-gray-700 hover:text-orange-500 font-bold transition-colors">
              Contact
            </Link>
          </nav>
